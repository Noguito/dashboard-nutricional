...
const MACROS_DB = {
  ...
  D5: { kcal: 345, prot: 23, carb: 26, gras: 16.5, portion: '20g avena + 2.5g chía + 50ml leche + 60g yogurt + 7.5 mermelada + 2.5 chocolate + 2 huevos', desc: 'Mezclar ingredientes base y refrigerar. Acompañar con huevos.' },
...
const INGREDIENTS_DB = {
  ...
  D5: [{ name: 'Avena', qty: 20, unit: 'g', cat: 'Carbohidratos' }, { name: 'Semillas de chía', qty: 2.5, unit: 'g', cat: 'Extras' }, { name: 'Esencia de vainilla', qty: 0.5, unit: 'cdita', cat: 'Extras' }, { name: 'Leche descremada/deslactosada', qty: 50, unit: 'ml', cat: 'Proteínas' }, { name: 'Yogurt griego natural Chivería', qty: 60, unit: 'g', cat: 'Proteínas' }, { name: 'Mermelada de fresa', qty: 7.5, unit: 'g', cat: 'Extras' }, { name: 'Chocolate negro', qty: 2.5, unit: 'g', cat: 'Extras' }, { name: 'Huevo', qty: 2, unit: 'un', cat: 'Proteínas' }],
